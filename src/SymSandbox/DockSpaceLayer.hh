...
namespace sym
{
  ...
  inline const std::string DockWinId::s_content  = "Simulation Content";
  inline const std::string DockWinId::s_settings = "Simulation Info";
      ...
      ImGui::Begin("Root", nullptr, window_flags);
      {
        ...
        if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
        {
          ...
          if (first_time)
          {
            ...
            ImGuiID left =
                ImGui::DockBuilderSplitNode(dock_space_main_id, ImGuiDir_Left, .4f, nullptr, &dock_space_main_id);
